...
public class Followers extends BotFile implements Runnable {
	...
	public void loadFollowers() {
		JsonObject obj = json.parse(
				HTTPConnect.GetResponsefrom("https://api.twitch.tv/kraken/channels/" + this.bot.getChannel(false) + "/follows?limit=100"))
				.getAsJsonObject();
		...
		BotWindow.output(LEVEL.Info, "Updated follower list for " + this.bot.getChannel(false));
	}
